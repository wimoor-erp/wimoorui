<template >
	...
	<template #field>
			...
			<el-table-column   label="父ASIN" header-align="center"  min-width="270px" fixed="left"  show-overflow-tooltip  prop="sku" >
				<template #header>
	...
	<template #field>
			...
			<el-table-column v-if="activeName=='msku'" label="本地SKU" header-align="center"  min-width="270px" fixed="left"  show-overflow-tooltip  prop="sku" >
				...
				<template #default="scope">
					...
					<img v-else :src="require('@/assets/image/empty/noimage40.png')" @click.stop="handleToMaterial(scope.row)" class="img-80"  width="80" height="80"  />
						<div style="margin-left:5px;">
