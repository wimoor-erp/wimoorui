	  ...
	  <GlobalTable ref="globalTable" :tableData="tableData" height="calc(100vh - 230px)" @loadTable="loadTableData" border style="width: 100%;margin-bottom:16px;">
	    ...
	    <el-table-column prop="price" label="重量（kg）" width="130"   >
		 ...
		 <el-table-column prop="price" label="尺寸分段" width="150"   >
		  ...
		  <el-table-column prop="price" label="FBA收费(每月预计超收费用)"     >
		  	 <template #default="scope">
...
<script setup>
	import { ref ,watch,reactive,onMounted,onUpdated,getCurrentInstance, toRefs,defineExpose,defineEmits} from 'vue';
