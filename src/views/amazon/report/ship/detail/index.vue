<template>
	<div   class="main-sty">
		  <el-row>
			  	<div class="con-header" style="margin-bottom:20px;">
					<el-space >
					<el-select v-model="selecttype" @change="handleQuery">
						<el-option   value="shipment" key="shipment" label="按货件汇总"></el-option>
						<el-option   value="sku" key="sku" label="按SKU汇总"></el-option>
					</el-select>
		   ...
		   <div class='rt-btn-group' style="margin-bottom:20px;">
			   <el-dropdown v-if="selecttype=='sku'" style="margin-right: 5px;">
			         <el-button type="primary">
			           导出<el-icon class="el-icon--right"><arrow-down /></el-icon>
			         </el-button>
			         <template #dropdown>
			           <el-dropdown-menu>
			             <el-dropdown-item @click.stop="downloadList('mainlist')">当前列表</el-dropdown-item>
			             <el-dropdown-item @click.stop="downloadList('other')">含子SKU</el-dropdown-item>
			           </el-dropdown-menu>
			         </template>
			       </el-dropdown>
				   <el-button v-else type="primary" @click.stop="downloadList('shipment')">导出</el-button>
	...
	<el-row v-else>
	<GlobalTable  
	  ref="skuglobalTable" :tableData="skutableData"   height="calc(100vh - 170px)" @loadTable="skuloadTableData" :stripe="true"  style="width: 100%;margin-bottom:16px;">
		 <template #field>
