<template>
	<div   class="main-sty">
		<el-tabs v-model="queryParam.type"  @tab-change="handleQuery">
		  ...
		  <el-row>
		   ...
		   <div class='rt-btn-group' style="margin-bottom:20px;">
			 <div class="font-extraSmall" style="padding-top:6px;">汇总指标:</div> 
		...
		<el-row>
			   <el-col :span="3" v-for="(value,key) in chartdata">
					<PieChart :name="key" :data="value" :keyvalue="fieldkey"></PieChart>
			   </el-col>
		</el-row>
	<el-row>
