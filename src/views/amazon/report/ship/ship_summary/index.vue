<template>
	<div   class="main-sty">
		  <el-row>
			  	<div class="con-header" style="margin-bottom:20px;">
					<el-space >
						<el-select v-model="queryParam.type" style="width:150px" @change="handleQuery">
													 <el-option value="logitics" key="logitics" label="物流承运商(汇总)"></el-option>
													 <el-option value="warehouse" key="warehouse"  label="FBA仓库(汇总)"> </el-option>
													 <el-option value="sku" key="sku"  label="SKU(汇总)"> </el-option>
						</el-select>
	...
	<GlobalTable
	  ...
	  style="width: 100%;margin-bottom:16px;">
		 <template #field>
		 <el-table-column prop="logitics"    v-if="queryParam.type=='logitics'" fixed="left"   label="物流承运商" width="150"  sortable="custom" />
		 <el-table-column prop="channame"    v-if="queryParam.type=='logitics'"  fixed="left" label="物流渠道" min-width="150"  sortable="custom" />
