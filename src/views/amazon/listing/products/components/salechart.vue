	...
	<el-dialog v-model="saleVisable" :title="productData.sku" :modal="false" :lock-scroll="false"    draggable>
		  <template #header>
			...
			<div class="flex-center">
						   <div class="font-Small"><span><span class="font-extraSmall">SKU:</span>{{skuname}}</span> <span><span class="font-extraSmall">总销量：</span>{{totalsales}}</span></div>
...
<script>
	...
	export default{
		setup(){
			...
			return{
				//value
				saleVisable,productData,activeMarket,spacer,radiotime,marketList,skuname,totalsales,
				//ref
				
				//function
				handleClick,loadChart,changeTimeType
			}
		}
	}
</script>
