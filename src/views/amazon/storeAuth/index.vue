					...
					<div class="el-card-head">
						...
						<div>
							<div class="text-right">
						     ...
						     <el-link type="info" size="small" linked @click="dialogRank.visible=true" :underline="false">
							<span class="font-extraSmall">调整次序</span></el-link>
						</div>
					</div>
...
<script>
	...
	export default{
		name:'Index',
		components:{Table,Plus,Edit,Delete,draggable},
		setup(){
			let storename = ref();
			let storeid=ref();
