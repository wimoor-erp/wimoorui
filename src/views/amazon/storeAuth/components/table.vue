					...
					<el-table :show-header="false" :data="item.regionslist" border  :span-method="rowmerge">
						...
						<el-table-column  prop="sellerauth">
							<template #default="scope">
								...
								<el-tag v-else  type="success">已授权</el-tag>
								 <el-button style="margin-left:10px;" title="刷新站点" v-if="scope.row.authid" link type="primary" size="small" @click="refreshAuth(scope.row.authid)">刷新</el-button>
							</template>	
						</el-table-column>
						<el-table-column  prop="adauth">
							<template #default="scope">
								...
								<el-tag v-else  type="success">已授权</el-tag>
								 <el-button style="margin-left:10px;" v-if="scope.row.advid"  title="刷新站点" link type="primary" size="small" @click="refreshAdv(scope.row.advid)">刷新</el-button>
							</template>	
						</el-table-column>
