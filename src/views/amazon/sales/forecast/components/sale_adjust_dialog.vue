		...
		<el-row class="m-t-16">
			<el-col :span="24">
				...
				<div v-else-if="radiotype=='预估同期'" v-loading="calendarloading" >
					<div  id="calendar" style='height:300px;width:100%'></div>
...
<script setup>
 ...
 function chartYearSale(leng,label,serdata){
	 nextTick(()=>{
 	  ...
 	  yearMyChart = echarts.init(document.getElementById("yearChart"));
 	document.getElementById("yearChart").oncontextmenu=function(){return false;}
 	  var symbolSize = 12;
