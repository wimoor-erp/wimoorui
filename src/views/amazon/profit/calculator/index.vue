			...
			<el-col  :span="7">
				<div class="gird-line-head">
					<el-space>
						...
						<el-input  v-model="queryParams.searchKeywords" placeholder="请输入" class="input-with-select" >
						   ...
						   <template #append>
						     <el-button @click.stop="searchParam">
				...
				<el-form  :model="formData" label-position="top" :rules="rules">
					...
					<el-form-item label="产品品类">
						<el-select v-model="formData.typeId" class="w-grow">
				...
				<ProfitDetails ref="profitDetailsRef" :tableData="formData" :countryOptions="countryMarketOptions"/>
				<div>
				...
				<FbaSize ref="fbaSizeRef"  :tableData="formData" :countryOptions="countryMarketOptions"/>
				</div>
			</div>	
			</el-col>
			<!-- 右边//右边///////////////////////////////////////////// -->
...
<script setup>
	import { ref ,watch,reactive,onMounted,defineExpose,toRefs} from 'vue'
