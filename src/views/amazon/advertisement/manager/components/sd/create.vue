					...
					<div v-if="show.adgroup">
						...
						<el-form-item label="竞价优化"  >
							 <el-radio-group v-model="form.bidOptimization"  >
								   <el-radio label="reach" v-if="campaign.costtype=='vcpm'" >针对受众触达量进行优化</el-radio>
								   <el-radio label="clicks" v-if="campaign.costtype=='cpc'" >针对页面访问次数进行优化</el-radio>
								   <el-radio label="conversions" v-if="campaign.costtype=='cpc'" >针对转化量进行优化</el-radio>
							 </el-radio-group>
						</el-form-item>
