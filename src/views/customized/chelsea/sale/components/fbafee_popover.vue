	   ...
	   <el-row>
		   ...
		   <el-col  :span="12">
			   <el-space  v-if="localRow.fba" diretion="vertical" fill>
				   ...
				   <el-divider class="line-margin"></el-divider>
				   <span><span class="light-font">FBA费用: </span><span class="font-bold"  >{{formatFloat(localRow.fba.estimated_fee_total-localRow.fba.estimated_referral_fee_per_unit)}}</span></span>
			   </el-space>
		   </el-col>
