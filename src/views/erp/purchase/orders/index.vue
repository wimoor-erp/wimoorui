			...
			<el-tabs v-model="activeName"  @tab-change="handleChange">
			  <el-tab-pane v-for="item in orderState"  :name="item.name" :key="item.name">
				  <template #label>
				    ...
				    <el-row>
				   <el-space>
					<GroupSelect  ref="groupRef"  @change="changeGroup" defaultValue="all" />
				   <Warehouse  ref="warehouseRef" @changeware="changeWarehouse" />
				   <Supplier  ref="supplierRef"   @change="changeSupplier" />
		           <el-select v-if="activeName=='4'" v-model="arrivalType"  @change="handleQuery" placeholder="收货状态">
						<el-option v-for="item in arrivalOptions" :label="item.label" :value="item.value" ></el-option>
					</el-select>  
				   <el-select v-if="activeName=='6'"  v-model="audistatusType" @change="handleQuery">
					   <el-option  label="全部完成" value="" ></el-option>
					   <el-option  label="付款完成" value="11" ></el-option>
					   <el-option  label="入库完成" value="12" ></el-option>
				   </el-select>
					  
				   <el-select v-if="activeName=='5'" v-model="payarrivalType"  @change="handleQuery" placeholder="收货状态">
				   ...
				   <div class="date-picker-group" >
				    ...
				    <el-row>
				     ...
				     <div class='rt-btn-group'>
						 <el-space>
						  <el-checkbox v-if="activeName=='5'" v-model="paymentType" label="已请款"  @change="handleQuery" />
