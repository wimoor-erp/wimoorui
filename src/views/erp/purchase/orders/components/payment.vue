			...
			<el-col :span="10">
				<el-card shadow="never" class="bg-full">
					...
					<el-form label-width="100px" label-position="top">
						...
						<el-row :gutter="24">
						 <el-col :span="12">
						<el-form-item  @click.stop="showPayIndexDialog">
							<template #label>
								<div class="pointer">支付方式<el-icon class="font-extraSmall"><Sort /></el-icon></div>
							</template>
						...
						<el-col :span="12">
						<el-form-item   @click.stop="toPaymentPage" class="pointer" >
							<template #label>
								<div class="pointer">支付账户 </div>
							</template>
