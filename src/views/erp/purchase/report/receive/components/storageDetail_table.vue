<template>
	<el-table :data="tableData.list" :stripe="true"  style="width: 100%;margin-bottom:16px;"  @sort-change="tableSort"  height="calc(100vh - 190px)">
		...
		<el-table-column prop="purchases" width="100" label="采购数量"  sortable="custom" />
		 <el-table-column prop="audittime" width="100" label="审核日期"  sortable="custom" >
		  ...
		  <el-table-column prop="deliverydate" width="130" label="预计到货日期"  sortable="custom" >
		   ...
		   <el-table-column prop="amount" width="180" label="入库数量"  show-overflow-tooltip sortable="custom" >
			   <template #default="scope">
