		  ...
		  <template #label>
			...
			<el-row>
				...
				<div class='rt-btn-group'>
					<div class='font-extraSmall' style="padding-top:8px;padding-right:10px;"> 请勿在新系统处理旧系统组装拆分单 </div>
...
<script setup>
	...
	function changeDate(value,val){
		state.queryParams.fromDate=val[0];
		state.queryParams.toDate=val[1];
		emits('change',state.queryParams);
	}
