<template>
	<div class="sys-headr-top">
		<el-space :size="8" class="font-base">
			<GroupSelect @change="handleGroupChange"
			defaultValue="all"></GroupSelect>
			<span>采购计划：</span>
			 <PlanSelect  @change="handlePlanChange"  defaultValue="only"></PlanSelect>
...
<script setup>
	...
	import {getSummary,clearItem} from '@/api/erp/purchase/plan/planApi';
