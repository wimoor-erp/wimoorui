	...
	<div class="customs-wrap">
		<el-table :data="productData.list" border style="width: 100%;" >
		  ...
		  <el-dialog
		   ...
		   >
		   <div style="margin-top:-10px">{{templatetitle}}</div> 
		   <el-row>
...
<script setup>
	...
	let{ uploadVisible,uploadloading,uploadTitle,myfile,tableData,search,templatetitle}=toRefs(state);
	...
	function downloadCustoms(id){
		...
		},shipInfo.value.shipment.shipmentConfirmationId+'-海关发票.xlsx');
	}
