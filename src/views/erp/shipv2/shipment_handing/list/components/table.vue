	   ...
	   style="width: 100%;margin-bottom:16px;">
	    ...
	    <el-table-column prop="skuamount" label="SKU个数" width="100"    sortable="custom">
		 ...
		 <el-table-column prop="sumQuantity" label="实际配货数量" width="125"  sortable="custom">
		   ...
		   <el-table-column prop="satus" label="状态" width="160" align="center"  >
			   <template #default="scope">
				    ...
				    <span 
					 ...
					 <el-icon  v-loading="scope.row.refreshloading"   @click="refreshShipmentRec(scope.row)"><Refresh /></el-icon>
					 </span>
...
<script setup>
	...
	import {Refresh,CircleClose,WarningFilled,Ship,HelpFilled,Van,Edit,PriceTag} from '@element-plus/icons-vue'
