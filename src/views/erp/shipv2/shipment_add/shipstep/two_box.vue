	...
	<div class="box-margin">
		<div class="pag-radius-bor mar-bot" >
			<div class=" two-box" > 
			  ...
			  <div class="boxgroup-subtext">以下装箱组中的SKU会一同配送，打包时请为包装箱编号，便于识别，装箱组中可包含多个包装箱。
			  <el-button @click="generatePackingOptions" :icon="Refresh" size="small"> {{packagetitle}}</el-button></div>
