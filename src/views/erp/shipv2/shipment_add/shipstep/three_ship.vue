						  ...
						  <div class="shiment-goods-wrap">
							  <div class="s-g-header">
								  <el-space size="large">
									  ...
									  <div>
										  <span>重量(kg)：{{item.totalweight}}</span>
									  </div>
									  <div>
										  <span>尺寸(方)：{{item.totalBoxSize}}</span>
									  </div>
									  <div>
									  	<span>材积：{{item.totalvolume}}</span>
									  </div>
									  <div>
									  	<span>货重比：{{getVolumeValue(item)}}</span>
									  </div>
								  </el-space>
							  </div>
							  <div class="s-g-body">
									  ...
									  <el-col :span="24">
										 ...
										 <div class="flex-center-between font-base">
											...
											<div class="flex-center-between"> 
											      <el-select :loading="item.shipment.loading" 
