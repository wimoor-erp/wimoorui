...
export default{
	 ...
	 saveTransportation,downLabel,list,getBaseInfo,getShipCart,saveTransTrace,downExcelBoxDetail,getPaper,
	 boxShipment,updateFeeByShipment,updateRemarkByShipment
}