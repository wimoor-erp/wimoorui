...
export default{
	getAuthUrl,getBindSeller,deleteByLogic,authSeller,getRegionByGroup,saveAuth,getAuthMaketplace,requestReportParamAuth,refreshMarketByAuth,uploadReportFile,getPerformance
}