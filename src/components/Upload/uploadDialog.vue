...
<script setup>
	   import {UploadFilled} from '@element-plus/icons-vue';
		...
		let state=reactive({visible:false,myfile:null,templateFile:"",title:"",callback:null});
		const{visible,myfile,title }=toRefs(state);
		...
		function downloadTemp(){
			   ...
			   if(state.templateFile){
				   downloadTemplateFileApi.downExcelTemp({"ftype":state.templateFile});
			   }
