<template>
	<el-tag class="pointer" v-if="feed_processing_status=='_DONE_' || feed_processing_status=='DONE'" title="请求已处理"
		@click="downloadFeedFile" type="success" :closable="false" >请求已处理</el-tag>
	<el-tag class="pointer" v-else-if="feed_processing_status" :title="feed_processing_name" @click="downloadFeedFile"
		type="warning" :closable="false" >{{feed_processing_name}}</el-tag>
